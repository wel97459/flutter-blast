...
void main() {
  group('Drag-and-Drop Interaction', () {
    testWidgets('should make each piece on the shelf draggable', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('GameBoardGrid should contain a DragTarget for pieces', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MyApp());
    ...
    testWidgets('Dragging a piece over the grid should show a ghost piece', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MyApp());
      ...
      // Now move just outside the visible board area.
      // The hover preview should remain visible near the edge while dragging.
      await gesture.moveTo(Offset(gridRect.right + 20, gridRect.center.dy));
    ...
    testWidgets(
      'Dragging a piece from the shelf to the grid should update the grid',
      (WidgetTester tester) async {
        ...
        final Offset dragPoint =
            gridTopLeft + Offset(160.0, 160.0 + piece.height * 40.0);
    ...
    testWidgets(
      'Dragging a piece onto an occupied spot should NOT update the grid',
      (WidgetTester tester) async {
        await tester.pumpWidget(const MyApp());
        ...
        final Offset dragPoint1 =
            gridTopLeft + Offset(160.0, 160.0 + piece1.height * 40.0);
        ...
        final Offset dragPoint2 =
            gridTopLeft + Offset(160.0, 160.0 + piece2.height * 40.0);
    ...
    testWidgets('Placing all three pieces should refill the shelf', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(const MyApp());
      ...
      final gesture1 = await tester.startGesture(
        tester.getCenter(pieceFinder1.at(0)),
      );
      await gesture1.moveTo(
        gridTopLeft +
            Offset(40.0 + piece1.width * 20.0, 40.0 + piece1.height * 40.0),
      );
      await tester.pump(const Duration(milliseconds: 100));
      await gesture1.up();
      await tester.pumpAndSettle();
      ...
      final gesture2 = await tester.startGesture(
        tester.getCenter(pieceFinder2.at(0)),
      );
      await gesture2.moveTo(
        gridTopLeft +
            Offset(200.0 + piece2.width * 20.0, 40.0 + piece2.height * 40.0),
      );
      await tester.pump(const Duration(milliseconds: 100));
      await gesture2.up();
      await tester.pumpAndSettle();
      ...
      final gesture3 = await tester.startGesture(
        tester.getCenter(pieceFinder3.at(0)),
      );
      await gesture3.moveTo(
        gridTopLeft +
            Offset(40.0 + piece3.width * 20.0, 200.0 + piece3.height * 40.0),
      );
      await tester.pump(const Duration(milliseconds: 100));
      await gesture3.up();
      await tester.pumpAndSettle();
