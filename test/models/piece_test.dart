...
void main() {
  group('Piece', () {
    ...
    test('generateRandomPiece generates a piece with a valid shape and color', () {
      final randomPiece = Piece.generateRandomPiece();
      expect(randomPiece, isA<Piece>());
      expect(randomPiece.shape.isNotEmpty, true);
      expect(randomPiece.color != 0, true); // Should have a non-transparent color
    });

    test('generateRandomPiece generates a piece from the predefined shapes', () {
      final randomPiece = Piece.generateRandomPiece();
